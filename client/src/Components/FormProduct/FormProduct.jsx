...
export default function FormProduct() {
  ...
  return (
    <div className={style.containerPrincipal}>
      <p className="mt-3"><Link to="/">Inicio</Link>/Crear Producto</p>
      ...
      <div className={style.container}>
        <form onSubmit={handleSubmit}>
          ...
          >Sumar al catalogo</button>

          {alert ?
            <div className={`${alert ? style.container_AlertDangerOpen : style.container_AlertDanger} alert alert-danger alert-dismissible fade show`}>
              Debes completar el formulario con la informacion <strong>correcta!</strong>
            ...
            (
              alert !== false ?
                <div></div>
                :
                <div className={`${alert ? style.container_AlertSuccess : style.container_AlertSuccessOpen} alert alert-success alert-dismissible fade show`} role="alert">
